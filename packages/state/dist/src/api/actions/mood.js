...
var cache = function (_a, _b) {
    ...
    moods.forEach(function (m) {
        ...
        if (!m.promise) {
            (_a = m.posts) === null || _a === void 0 ? void 0 : _a.forEach(function (p) {
                return p.id &&
                    (state.api.cache.posts[p.id] = __assign(__assign({}, state.api.cache.posts[p.id]), p));
            });
        }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    (_b = r.data.value) === null || _b === void 0 ? void 0 : _b.forEach(function (p) {
                        return p.id &&
                            (state.api.cache.posts[p.id] = __assign(__assign({}, state.api.cache.posts[p.id]), p));
                    });
                    return [2 /*return*/];
