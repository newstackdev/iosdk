        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, state.api.client.mood.listTopList({
                            page: page.toString()
                        })];
                case 1:
                    r = _d.sent();
                ...
                case 2:
                    _d.sent();
                    (0, core_1.fischerYates)(moods).forEach(function (v) {
...
exports.listTopUsers = (0, overmind_1.pipe)((0, overmind_1.debounce)(300), function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    page = state.lists.top.users.page
                        ? state.lists.top.users.page + 1
                        : Math.floor(Math.random() * 10);
                    return [4 /*yield*/, state.api.client.user.listTopList({
                            page: page.toString()
                        })];
                case 1:
                    r = _c.sent();
...
exports.listTopPosts = (0, overmind_1.pipe)((0, overmind_1.debounce)(300), function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    page = state.lists.top.posts.page
                        ? state.lists.top.posts.page + 1
                        : 0;
                    return [4 /*yield*/, state.api.client.post.listTopList({
                            page: page.toString()
                        })];
                case 1:
                    r = _d.sent();
