...
var baseUrl = core_1.newlifeBaseUrl;
var Websocket = function () {
    var state = {
        socket: null
    };
    var toggle = function (url) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.Api = (function () {
    ...
    return {
        initialize: function () {
            api = new core_1.CreatorApi({
                baseUrl: baseUrl,
                securityWorker: function (securityData) {
                    console.log("Token is ", securityData === null || securityData === void 0 ? void 0 : securityData.token);
                    return !securityData
                        ? {}
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, api.user.currentList()];
                        case 1:
                            r = _a.sent();
