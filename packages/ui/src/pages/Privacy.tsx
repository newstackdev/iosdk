            ...
            <div style={{ outline: "none" }}>
                <div className="legal-info">
                    ...
                    <p className="legal-info-content"><br />
                        ...
                        <br />
                        Newlife.IO may collect and use User's personal information for the following purposes:<br />
                        <br />
                        ...
                        <br />
                        To improve our website and personalize user experience (We may use information in the aggregate to understand how our Users as a group use the services and resources provided on our Site and to help us to better respond to individual needs).<br />
                        <br />
                        To improve our App (We may use feedback you provide to improve our products and services).<br />
                        <br />
                        ...
                        <br />
                        To send periodic emails (We may use the email address to respond to inquiries, questions, and/or other requests. If User decides to opt-in to our mailing list, they will receive emails that may include company news, updates, related product or service information, etc. If at any time the User would like to unsubscribe from receiving future emails, we include detailed unsubscribe instructions at the bottom of each email).<br />
                        <br />
                        HOW DO WE PROTECT YOUR INFORMATION?<br />
                        <br />
                        We implement a variety of security measures to maintain the safety of your personal information when you submit a request or enter, submit, or access your personal information. These security measures include: password protected directories and databases to safeguard your information.<br />
                        <br />
                        ...
                        <br />
                        We do not sell, trade, or otherwise transfer to outside parties your personally identifiable information. This does not include trusted third parties who assist us in operating our website, conducting our business, or servicing you, so long as those parties agree to keep this information confidential. We may also release your information when we believe release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property, or safety. However, non-personally identifiable visitor information may be provided to other parties.<br />
                        <br />
                        ...
                        <br />
                        As part of the California On-line Privacy Protection Act, all users of our site may make any changes to their information at any-time by logging into their control panel and going to the 'Edit Profile' page.<br />
                        <br />
                        ...
                        <br />
                        CAN-SPAM COMPLIANCE<br />
                        <br />
                        We have taken the necessary steps to ensure that we are compliant with the CAN-SPAM Act of 2003 by never sending out misleading information.<br />
                        <br />
                        ...
                        <br />
                        Please also visit our Terms and Conditions section establishing the use, disclaimers, and limitations of liability governing the use of our website at /about/tos/.<br />
                        <br />
                        YOUR CONSENT<br />
                        <br />
                        ...
                        <br />
                        If we decide to change our privacy policy, we will post those changes on this page, send an email notifying you of any changes, and/or update the Privacy Policy modification date below. Policy changes will apply only to information collected after the date of the change.<br />
                        <br />
                        This policy was last modified on APRIL 20, 2021<br />
                        <br />
                        CONTACTING US<br />
                        <br />
                        If you have any questions or comments regarding this Privacy Policy, please contact us using the information below:<br />
                        <br />
                        Newlife.ai s.r.o., located at Kurzova 2222/16, Stodůlky, 155 00 Praha<br />
                        The present terms are governed by the laws of the Czech Republic.<br />
                        so [AT] Newlife [DOT] ai<br />
                    </p>
                </div>
            </div>
        </div>
