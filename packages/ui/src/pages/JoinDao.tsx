...
export const JoinDaoWidget = ({
	...
	return (
		...
		>
			...
			{isMember ? (
				<>
					...
					<div style={{ textAlign: "left" }}>
						...
						<Link to={`/user/${APP_DOMAIN}`}>${APP_DOMAIN}</Link>{" "}
						home page.
					</div>
				</>
			) : (
				<>
					...
					>
						Newlife is governed by the community. To join the app,
						you need to own at least 1000 $LIFE on your account.
					</p>
			...
			>
				Learn more about{" "}
				<span className="paragraph-2u"> app staking</span>
			</p>
		</Modal>
	);
};
