...
import usePreventBodyScroll from "@newcoin-foundation/hooks/dist/src/usePreventBodyScroll";
  ...
  return (
    <div style={{ marginBottom: 24 }}>
      <Link to={`/user/${u.username}`}>
        <MediaComponent size="small" width="100%" src={u.contentUrl} />
      </Link>
    ...
    <>
      ...
      >
        <Row align="middle" className="text-center">
          <Col span={8} className="nl-avatar">
            <Avatar
              size="large"
              src={<MediaComponent size="medium" {..._user} />}
            />
          </Col>
        </Row>
      ...
      >
        <Row align="middle" className="text-center">
          ...
          <Col span={12} className="text-left">
            <div>
              You {preStakeValue ? "increased your stake in" : "joined"}
              <br />
              <b style={{ fontSize: "1.3em" }}>{_user?.username}</b>
              's DAO.
            </div>
          </Col>
        </Row>
        <div className="text-center">
          ...
          {preStakeValue ? (
            <>
              Your stake in {_user?.username}'s DAO increased by {stakeDelta}{" "}
              {poolInfo.code}.
            </>
          ) : (
            <>
              You are now a member of the {_user?.username}'s DAO with all the
      ...
      >
        ...
        {membershipValue ? (
          <>
            {" "}
            increase your stake in {_user?.username || ""}'s DAO by {_value}{" "}
            $NCO
          </>
        ) : (
          <>
            {" "}
            stake {_value} $NCO to join {_user?.username || ""}'s DAO?
          </>
        )}
        ?
        <br />
      ...
      >
        <Row align="middle" className="text-center nl-row-vertical-space">
          ...
          <Col span={24}>
            {membershipValue > 0 ? (
              <>
                Your current stake in {_user?.username || ""}'s DAO is{" "}
                {poolInfo.code} {membershipValue}. Stake {_value} NCO more to
          ...
          <div>
            <Row align="middle" className="text-center">
              <Col span={8} className="nl-avatar">
                <Avatar
                  size="large"
                  src={<MediaComponent size="medium" {...user} />}
                />
              </Col>
              ...
              <Col span={12} className="text-left">
                <div>
                  ...
                  <br />
                  <b style={{ fontSize: "1.3em" }}>{user?.username}</b>
                </div>
              </Col>
            </Row>
        ...
        >
          <Col xs={24} sm={12} className="username">
            ...
            {u.id === state.api.auth.user?.id ? (
              <Link title="Public view" to={`/user/${u.username}`}>
                <EyeOutlined />
              </Link>
            ) : (
              ""
    ...
    <List
      ...
      renderItem={(u) => {
        return (
          <List.Item>
            <List.Item.Meta
              avatar={<Avatar src={<MediaComponent {...u} />} />}
              description={
                <Row
                  align="middle"
                  gutter={18}
        ...
        {users?.map((u, i) => {
          return (
            ...
            >
              ...
              >
                <Avatar src={<MediaComponent size="medium" {...u} />} />
              </Col>
              <Col /*sm={16} xxl={8}*/>
    ...
    <ItemGrid
      ...
      render={(u: UserReadPublicResponse) => {
        return (
          ...
          >
            <Col sm={10} xxl={4}>
              <Avatar src={<MediaComponent size="small" {...u} />} />
            </Col>
            <Col sm={14} xxl={20}>
...
export const PoolInfoDataRow: NLView<{ pool?: { code: string } }> = ({
  ...
  return (
    <DataRow
      title={<Link to={`/user/${poolInfo?.owner}`}>{poolInfo?.owner}</Link>}
