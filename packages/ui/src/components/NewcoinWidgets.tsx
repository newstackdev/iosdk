...
import { useCachedNewconAccountHistory } from "@newcoin-foundation/hooks";
...
export const StakeControl: NLView<{ stakeInfo: StakeInfo }> = ({
  stakeInfo,
}) => {
  return (
    <>
...
export const UserHistoryControl: NLView<{ user: { username?: string } }> = ({
  user,
}) => {
...
export const NewcoinWidget: NLView<{ user: { username?: string } }> = ({
  user: { username },
}) => {
