...
var useVotingStreamMood = function () {
    ...
    var currPost = (0, hooks_1.useCachedPost)({ id: postId || id }, true);
    var currMood = (0, hooks_1.useCachedMood)({ id: moodId }, true);
...
var Post = function () {
    ...
    var author = (0, hooks_1.useCachedUser)({ id: currPost ? (_a = currPost === null || currPost === void 0 ? void 0 : currPost.author) === null || _a === void 0 ? void 0 : _a.id : "" });
    var username = author === null || author === void 0 ? void 0 : author.username;
            ...
            , __assign({ 
                ...
                votingEnabled: isInMood, onDoneVoting: doneVoting, onLongDoneVoting: function () {
                    ...
                    return function () {
                        ...
                        })] })) }, { children: /PROCESSING/i.test(currPost.contentUrl || "") ? ((0, jsx_runtime_1.jsx)(Spin_1.Spin, { title: "Processing media..." })) : ((0, jsx_runtime_1.jsx)(MediaComponents_1.MediaComponent, __assign({}, currPost, { thumbnail: false }))) })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "text-right app-main-full-width" }, { children: (0, jsx_runtime_1.jsx)(PostModal_1["default"], {}) })), (0, jsx_runtime_1.jsx)("div", __assign({ hidden: state.flows.rating.value !== 100, className: "app-main-full-width" }, { children: (0, jsx_runtime_1.jsx)(SelectMood_1.SelectMoodForm, { onFinish: addToMoods, title: "Select a folder to share to" }) }))] }));
};
exports.Post = Post;
