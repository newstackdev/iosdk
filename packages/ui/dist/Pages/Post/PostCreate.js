...
var initialLicense = { name: core_1.LICENSES[0][0], value: core_1.LICENSES[0][1] };
var mintNTFcolor = {
    white: "#FCFCF3",
    purple: "#c46ef7",
    green: "#b3ff00",
...
var PostCreate = function (props) {
    ...
    var _c = (0, react_1.useState)({
        name: core_1.LICENSES[0][0],
        value: core_1.LICENSES[0][1]
    }), selectedLicense = _c[0], setSelectedLicense = _c[1];
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "section-divider" }, { children: [(0, jsx_runtime_1.jsx)(form_1["default"], __assign({ hidden: moodMode || !post, name: "basic", form: form, initialValues: { remember: true, licence: "BY-0" }, onFinish: onFinish, onFinishFailed: onFinishFailed, autoComplete: "off" }, { children: (0, jsx_runtime_1.jsx)(ContentLayout_1.ContentLayout, __assign({ isPost: true, header: (0, jsx_runtime_1.jsx)(PostCreateHeader_1["default"], { selectedLicense: selectedLicense, ncoBalance: ncoBalance, contentType: contentType, setContentType: setContentType }), info: (0, jsx_runtime_1.jsx)(PostCreateInfo_1["default"], { selectedLicense: selectedLicense, setSelectedLicense: setSelectedLicense, isLicense: isLicense, setIsLicense: setIsLicense, mintConfirmationOpen: mintConfirmationOpen, ncoBalance: ncoBalance }) }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "post-create-form-width" }, { children: [(0, jsx_runtime_1.jsx)(form_1["default"].Item, __assign({ required: true, name: "title", rules: [
                                ...
                                ] }, { children: (0, jsx_runtime_1.jsxs)(antd_1.Row, { children: [(0, jsx_runtime_1.jsx)("p", __assign({ className: "header-5", style: { marginBottom: "20px" } }, { children: contentType ? "Post" : "Description" })), (0, jsx_runtime_1.jsx)(antd_1.Input.TextArea, { placeholder: contentType ? "A new idea?✨" : "What's it about?✨" })] }) })), (0, jsx_runtime_1.jsxs)(form_1["default"].Item, __assign({ name: "doMint" }, { children: [(0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ align: "middle", style: {
                                            marginBottom: "10px"
                                                    ...
                                                    : "Mint your content as an NFT on the Newcoin Network! For now, you can't trade this!", overlayClassName: ncoBalance === 0 ? "tooltip-zero-balance" : "" }, { children: (0, jsx_runtime_1.jsx)("span", { children: (0, jsx_runtime_1.jsx)(Info_1.Info, { color: ncoBalance === 0
                                                            ? mintNTFcolor.purple
                                                            : mintNTFcolor.white }) }) }))] })), (0, jsx_runtime_1.jsx)(react_switch_1["default"], { onChange: function () { return setMintNFTswitch(function (p) { return !p; }); }, checked: mintNFTswitch, checkedIcon: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), uncheckedIcon: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), onColor: ncoBalance === 0 ? mintNTFcolor.purple : mintNTFcolor.green, offColor: ncoBalance === 0 ? mintNTFcolor.purple : mintNTFcolor["default"], disabled: ncoBalance === 0 ? true : false })] })), (0, jsx_runtime_1.jsxs)(form_1["default"].Item, __assign({ name: "license", style: {
                                    marginBottom: "40px",
                                    height: "15vh"
