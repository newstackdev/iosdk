...
var UserInvite = function () {
    ...
    return ((0, jsx_runtime_1.jsx)(ContentLayout_1.ContentLayout, { children: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h2", __assign({ className: "app-main-title-spacing header-2" }, { children: "Invite a friend" })), (0, jsx_runtime_1.jsxs)(antd_1.Form, __assign({ name: "basic", form: form, 
                    // labelCol={{ span: 6 }}
                    wrapperCol: { span: 24 }, 
                    // value={{ state }}
                    onFinish: function (data) { return actions.api.user.invite({ userInvite: data }); }, 
                    ...
                    autoComplete: "off" }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, __assign({ name: "phone", rules: [
                            ...
                            ] }, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "username" }) })), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, __assign({ wrapperCol: { offset: 8, span: 16 } }, { children: (0, jsx_runtime_1.jsx)(ProgressButton_1.ProgressButton, __assign({ actionName: "api.user.invite", type: "primary", htmlType: "submit" }, { children: "Submit" })) }))] }))] }) }));
};
