...
var JoinDaoWidget = function (_a) {
    ...
    var justStaked = __spreadArray([], state.api.cache.stakeHistory, true).reverse()
        .find(function (h) { return h.user.username === core_1.APP_DOMAIN; });
    var isStaking = state.indicators.specific["api.user.stake"];
    var APP_USER = { username: core_1.APP_DOMAIN };
    ...
    var done = function (_a) {
        var _b = _a === void 0 ? {
            ...
            stakeValue: 0,
            preStakeValue: 0
        } : _a, stakeDelta = _b.stakeDelta, stakeValue = _b.stakeValue, preStakeValue = _b.preStakeValue;
        if (isMember &&
            ((!preStakeValue && stakeDelta && state.flows.user.create.justCreated) ||
