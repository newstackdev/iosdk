...
var SearchCreativePost = function () {
    ...
    var doneVoting = function (vote) {
        ...
        actions.routing.historyPush({
            location: "/search-creative/vote?tags=".concat(tags, "&aesthetics=").concat(aesthetics, "&index=").concat(index + 1)
        });
    };
    if (!item)
    ...
    , __assign({ 
        // useVotingStream={useVotingStreamMood}
        onDoneVoting: doneVoting, info: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: Object.entries(item.aesthetics || []).map(function (a) { return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { children: a[0] }), (0, jsx_runtime_1.jsx)(antd_1.Progress, { strokeColor: "#c1fa50", percent: a[1] * 100 })] })); }) }) }, { children: (0, jsx_runtime_1.jsx)(antd_1.Image, { preview: false, src: item.image }) })));
};
