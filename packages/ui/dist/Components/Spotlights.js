...
var SpotlightGrid = function (_a) {
    ...
    // const m = useCachedMood(mood);
    // const postsList = m.posts?.slice(0, 1);
    var moodsList = (0, core_1.fischerYates)((0, state_1.useAppState)().lists.top.moods.items || [], maxItems || 6);
    var postsList = moodsList.map(function (m) { return (0, core_1.fischerYates)(m.posts || [], 1)[0]; });
