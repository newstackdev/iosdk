...
var PostWidget = function (_a) {
    ...
    var p = post;
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(MaybeLink, __assign({ to: !p.id ? "" : !mood ? "/post/".concat(p.id) : "/folder/".concat(mood.id, "/").concat(p.id), className: p.contentType === "text/plain" ? "maybelink" : "" }, { children: p.contentType === "text/plain" ? ((0, jsx_runtime_1.jsx)("div", __assign({ className: "text-container" }, { children: (0, jsx_runtime_1.jsxs)("p", __assign({ className: "text-mood" }, { children: ["\"", ((_b = p.content) === null || _b === void 0 ? void 0 : _b.length) > 17
                            ? ((_c = p === null || p === void 0 ? void 0 : p.content) === null || _c === void 0 ? void 0 : _c.substring(0, 12)) + "..."
                            : p.content || "", "\""] })) }))) : ((0, jsx_runtime_1.jsx)(MediaComponent_1.MediaComponent, __assign({ size: "small" }, p, { width: "100%", style: { aspectRatio: "".concat(aspectRatio) }, className: isSpotlight || aspectRatio >= 1 ? "post-rounded" : "" }))) })) }));
    // return <Card
    //     style={{ width: "100%" }}
