...
var usePreventBodyScroll_1 = __importDefault(require("@newcoin-foundation/hooks/dist/src/usePreventBodyScroll"));
var state_1 = require("@newcoin-foundation/state");
var MediaComponents_1 = require("./MediaComponents");
var ellipsisStyle = {
    maxWidth: 125,
    whiteSpace: "nowrap",
...
var UserWidgetVertical = function (_a) {
    var user = _a.user;
    var u = (0, hooks_1.useCachedUser)({ id: (user === null || user === void 0 ? void 0 : user.id) || "" });
    if (!u)
        return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {});
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ style: { marginBottom: 24 } }, { children: [(0, jsx_runtime_1.jsx)(react_router_dom_1.Link, __assign({ to: "/user/".concat(u.username) }, { children: (0, jsx_runtime_1.jsx)(MediaComponents_1.MediaComponent, { size: "small", width: "100%", src: u.contentUrl }) })), (0, jsx_runtime_1.jsxs)(react_router_dom_1.Link, __assign({ to: "/user/stake/".concat(u.username), hidden: !u.username }, { children: ["Stake on ", u.username] }))] })));
};
...
var UserStake = function (_a) {
    ...
    var poolInfo = (0, hooks_1.useCachedPool)({ owner: user === null || user === void 0 ? void 0 : user.username });
    ...
    var _user = (0, hooks_1.useCachedUser)(user, true);
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(antd_1.Modal, __assign({ visible: _mode == exports.STAKE_STEPS.NODAO, cancelText: "Ok", 
                ...
                onCancel: function () {
                    ...
                    setMode(exports.STAKE_STEPS.DISABLED);
                }, cancelButtonProps: { value: "No" }, footer: false, className: "nl-white-box-modal" }, { children: [(0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ align: "middle", className: "text-center" }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ span: 8, className: "nl-avatar" }, { children: (0, jsx_runtime_1.jsx)(antd_1.Avatar, { size: "large", src: (0, jsx_runtime_1.jsx)(MediaComponents_1.MediaComponent, __assign({ size: "medium" }, _user)) }) })), (0, jsx_runtime_1.jsx)(antd_1.Col, { span: 4 }), (0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ span: 12, className: "text-left" }, { children: (0, jsx_runtime_1.jsxs)("div", { children: ["You ", preStakeValue ? "increased your stake in" : "joined", (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("b", __assign({ style: { fontSize: "1.3em" } }, { children: _user === null || _user === void 0 ? void 0 : _user.username })), "'s DAO."] }) }))] })), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "text-center" }, { children: [(0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("h2", __assign({ className: "header-2" }, { children: "Congratulations!" })), preStakeValue ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: ["Your stake in ", _user === null || _user === void 0 ? void 0 : _user.username, "'s DAO increased by ", stakeDelta, " ", poolInfo.code, "."] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: ["You are now a member of the ", _user === null || _user === void 0 ? void 0 : _user.username, "'s DAO with all the rights and duties associated."] })), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsxs)("p", __assign({ className: "text-left" }, { children: [_value, " $NCO", (0, jsx_runtime_1.jsx)("br", {}), "\u2014 ", round((fee * 5) / 8), " $NCO (5%) creator fee", (0, jsx_runtime_1.jsx)("br", {}), "\u2014 ", round((fee * 3) / 8), " $NCO (3%) DAO fee", (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("br", {}), "Total stake:"] })), (0, jsx_runtime_1.jsxs)("h1", { children: [round(_value - fee), " NCO"] }), (0, jsx_runtime_1.jsx)(antd_1.Button, __assign({ className: "nl-button-primary", onClick: function () { return openUrl("newcoin"); } }, { children: "View on Newcoin" })), (0, jsx_runtime_1.jsx)(antd_1.Button, __assign({ className: "nl-button-primary", onClick: function () { return openUrl("blocks"); } }, { children: "View on Blocks" }))] }))] })), (0, jsx_runtime_1.jsxs)(antd_1.Modal, __assign({ visible: _mode === exports.STAKE_STEPS.CONFIRM, title: "Confirm your request", okText: "Yes", cancelText: "No", onOk: function () { return stake(); }, closeIcon: (0, jsx_runtime_1.jsx)(CrossCircle_1.CrossCircle, {}), onCancel: function () {
...
var UserPowerup = function (_a) {
    ...
    var actions = (0, state_1.useActions)();
    var state = (0, state_1.useAppState)();
    var currentUserPowerups = (0, hooks_1.useCachedPowerups)();
    var poolInfo = (0, hooks_1.useCachedPool)({ owner: user === null || user === void 0 ? void 0 : user.username });
    var membershipValue = state.newcoin.pools[poolInfo.code];
...
var UserWidgetHeading = function (_a) {
    ...
    var u = (0, hooks_1.useCachedUser)({ username: user === null || user === void 0 ? void 0 : user.username }, true);
    var state = (0, state_1.useAppState)();
    if (!user)
        return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {});
    // return <Card title={""}
    // cover={<MediaComponent width="100%" src={user.contentUrl} />}
    // >
    return ((0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ wrap: true, 
        // gutter={30}
        align: "middle", style: { textAlign: "center", minHeight: 250 }, className: "app-main-full-width" }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ span: 8, className: "nl-avatar" }, { children: (0, jsx_runtime_1.jsx)(antd_1.Avatar, { src: (0, jsx_runtime_1.jsx)(MediaComponents_1.MediaComponent, __assign({}, u)) }) })), (0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ span: 16, className: "user-widget-heading" }, { children: (0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ className: "user-widget-heading", style: { width: "100%", textAlign: "left" }, justify: "start" }, { children: [(0, jsx_runtime_1.jsxs)(antd_1.Col, __assign({ xs: 24, sm: 12, className: "username" }, { children: [(0, jsx_runtime_1.jsx)("h2", __assign({ className: "header-2" }, { children: (0, jsx_runtime_1.jsx)(react_router_dom_1.Link, __assign({ to: "/user/".concat(u.username) }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ style: {
                                                wordBreak: "break-all",
                                                maxWidth: "100%",
                                                minHeight: "1.5em"
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [title ? (0, jsx_runtime_1.jsx)("h4", __assign({ className: "header-4" }, { children: title })) : "", (0, jsx_runtime_1.jsx)(antd_1.List
            ...
            , { 
                ...
                itemLayout: layout || "horizontal", dataSource: users || [], renderItem: function (u) {
                    return ((0, jsx_runtime_1.jsx)(antd_1.List.Item, { children: (0, jsx_runtime_1.jsx)(antd_1.List.Item.Meta, { avatar: (0, jsx_runtime_1.jsx)(antd_1.Avatar, { src: (0, jsx_runtime_1.jsx)(MediaComponents_1.MediaComponent, __assign({}, u)) }), description: (0, jsx_runtime_1.jsx)(antd_1.Row, __assign({ align: "middle", gutter: 18, className: "app-main-full-width-only", justify: "start", wrap: true }, { children: (0, jsx_runtime_1.jsxs)(antd_1.Col, __assign({ sm: 24, xxl: 24 }, { children: [(0, jsx_runtime_1.jsx)(react_router_dom_1.Link, __assign({ to: "/user/".concat(u.username), className: "paragraph-1r" }, { children: u.username })), (0, jsx_runtime_1.jsx)(Paragraph_1["default"], __assign({ style: { marginBottom: "0" }, className: "paragraph-2r" }, { children: u.powered || "" }))] })) })) }) }));
                } })] }));
};
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [title ? (0, jsx_runtime_1.jsx)("h2", __assign({ className: "app-main-full-width" }, { children: title })) : "", (0, jsx_runtime_1.jsx)(ItemGrid_1.ItemGrid
            ...
            , { 
                ...
                items: users || [], render: function (u) {
                    return ((0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ align: "middle", gutter: 6, style: { padding: 12 }, justify: "center", wrap: true }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ sm: 10, xxl: 4 }, { children: (0, jsx_runtime_1.jsx)(antd_1.Avatar, { src: (0, jsx_runtime_1.jsx)(MediaComponents_1.MediaComponent, __assign({ size: "small" }, u)) }) })), (0, jsx_runtime_1.jsxs)(antd_1.Col, __assign({ sm: 14, xxl: 20 }, { children: [(0, jsx_runtime_1.jsx)(react_router_dom_1.Link, __assign({ to: "/user/".concat(u.username) }, { children: u.username })), (0, jsx_runtime_1.jsx)("br", {}), u.powered || ""] }))] })));
                } })] }));
};
...
var PoolInfoDataRow = function (_a) {
    var pool = _a.pool;
    var poolInfo = (0, hooks_1.useCachedPool)(pool);
    var myPools = (0, state_1.useAppState)().newcoin.pools;
...
var UserNewcoinPoolsParticipation = function (_a) {
    ...
    var nc = (0, state_1.useAppState)().newcoin;
