...
var ItemGrid = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [title === undefined ? ((0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ style: { width: "100%", marginTop: "20px" } }, { children: [(0, jsx_runtime_1.jsx)(LargeArrowBack_1.LargeArrowBack, {}), (0, jsx_runtime_1.jsx)("p", __assign({ className: "header-2", style: { marginLeft: "40px" } }, { children: title }))] }))) : ((0, jsx_runtime_1.jsx)(Title_1["default"], { title: title, href: titleLink })), items.length ? ((0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ wrap: true, className: limit
