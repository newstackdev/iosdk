...
var ContentLayoutHorizontal3col = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ justify: "space-between", gutter: 16, className: "app-main-full-width", style: { margin: 0, height: "100%" } }, { children: [header ? ((0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ xs: 24, lg: isPost ? 7 : isMood ? 6 : 4, className: isPost ? "text-left post-notification-column" : "text-left", style: isPost ? { display: "flex" } : {} }, { children: header }))) : (""), (0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ xs: 24, lg: isPost ? 18 - extrasSpan : isMood ? 20 - extrasSpan : 24 - extrasSpan, className: "".concat(customClass), style: extrasSpan
                    ? { display: "flex" }
