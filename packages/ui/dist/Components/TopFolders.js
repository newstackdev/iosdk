...
var TopFoldersGrid = function (_a) {
    ...
    var m = (0, hooks_1.useCachedMood)(mood);
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ style: { width: "100%" }, className: title === "Moods" ? "scrollable-content" : "" }, { children: (0, jsx_runtime_1.jsxs)(antd_1.Row, __assign({ style: {
            ...
            }, className: "".concat(noFullWidth ? "nl-mood-grid-row-height" : "app-main-full-width", " ").concat(title === "Moods" ? "nl-mood-grid-row-four" : "") }, { children: [!noFolder && ((0, jsx_runtime_1.jsxs)(antd_1.Col, __assign({ style: {
