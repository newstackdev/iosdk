    ...
    ({ stakeInfo, onClick }) =>
        <div
            ...
            <div
                ...
                style={{ background: "rgba(0,0,0,.3)", padding: "20px", borderRadius: 30, width: "auto", maxWidth: "min(100vw,600px)", marginLeft: "auto", marginRight: "auto" }}>
                Premium content: stake {stakeInfo.currentUserNeeds} ${stakeInfo.currency} to access.<br />
                <br />
                <UserStake
                    onDone={() => { }}
                    user={stakeInfo.owner}
                />
            </div>
...
export const PremiumContent: IOView<{
    ...
    ({ stakeToAccess, owner, children, className, style, privateContentView, link, ...rest }) => {
        ...
        return <>
            ...
            {blur ?
                <PrivateContentView stakeInfo={stakeInfo} onClick={onClick} />
                :
                <></>
            }
        </>
