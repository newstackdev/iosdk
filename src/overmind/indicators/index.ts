...
const exposeIndicators = ({ state }: any, { actionName }: { actionName: string }) => {
...
const isWorkingActionDebounced: Action<{ actionName: string }> = pipe(debounce(300), exposeIndicators);
