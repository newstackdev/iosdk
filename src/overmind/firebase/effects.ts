// import '../App.css';
import { Auth, ConfirmationResult, getAuth, RecaptchaVerifier, sendSignInLinkToEmail, signInWithEmailAndPassword, signInWithEmailLink, signInWithPhoneNumber } from "firebase/auth";
...
export default (() => {
  ...
  return {
      ...
      async requestEmailAuthCode (v: { email: string }) {
        ...
        const actionCodeSettings = { // Legacy V1 login only
