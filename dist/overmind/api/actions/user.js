        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!(id || username))
                        return [2 /*return*/];
                    known = (id && state.api.cache.users.byId[id]) || (username && state.api.cache.users.byUsername[username]);
                    return [4 /*yield*/, (known ? Promise.resolve({ data: known }) : state.api.client.user.userList(__assign(__assign({}, (id ? { id: id } : {})), { username: username })))];
                case 1:
                    ur = _c.sent();
                    id = id || ur.data.id || "";
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _c = _d.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, state.api.client.user.userCreate(__assign(__assign({}, user), { legacyToken: state.flows.user.create.legacyToken }))];
                case 3:
                    _c = _d.sent();
                    _d.label = 4;
                case 4:
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, state.api.client.user.uploadCreate({ filename: file.name, contentType: file.type })];
                case 2:
                    uploadInfo = _e.sent();
                ...
                case 3:
                    r = _e.sent();
                    return [4 /*yield*/, actions.api.user.cache({ user: __assign(__assign(__assign({}, state.api.auth.user), user), { contentUrl: "processing" }) })];
                case 4:
                    _e.sent();
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    u = _c.sent();
                    return [4 /*yield*/, state.api.client.user.stakeCreate({ username: (u === null || u === void 0 ? void 0 : u.username) || "", amount: amount })];
                case 2:
                    res = _c.sent();
                    state.api.cache.stakeHistory.push({ user: user, amount: amount, response: res, error: null });
                ...
                case 3:
                    ...
                    state.api.cache.stakeHistory.push({ user: user, amount: amount, response: null, error: ex_2 });
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, state.api.client.user.rateCreate({ targetId: user.id, value: amount || 1 })];
                case 1:
                    res = _c.sent();
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    state.routing.simpleHistory[0].search.slice(1).split(/&/).map(function (kv) { return kv.split(/=/); }).reduce(function (r, _a) {
                        var _b;
                        var k = _a[0], v = _a[1];
