        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    if (!postForm.content)
                        return [2 /*return*/, effects.ux.notification.open({ message: "Write something smart here." })];
                ...
                case 2:
                    ...
                    if (!f.type) {
                        return [2 /*return*/, effects.ux.notification.open({ message: "Unrecognized/unsupported content type. Upload something else." })];
                    }
                    return [4 /*yield*/, state.api.client.post.postCreate(postForm)];
                case 3:
                    p = _h.sent();
