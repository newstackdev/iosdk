    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    res = (_b.sent()) || { data: { Items: [] } };
                    items = __spreadArray([], ((res.data || {}).Items || []), true).reverse();
                    items.forEach(function (ev) { return actions.websockets.processIncoming({ msg: JSON.stringify(ev) }); });
...
function (ctx, _a) {
    ...
    var what = (0, capFirst_1.capFirst)(model);
...
exports.default = {
    ...
    actions: actions,
    effects: {
        newlife: (0, effects_1.default)(function (token) { return "".concat(config_1.newlifeWebsocketsServer, "?token=").concat(token); })
    }
};
