    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _c = state.newcoin;
                    return [4 /*yield*/, effects.newcoin.newcoin.getAccountBalance({ owner: user.username || "" })];
                case 1:
                    _c.account = _e.sent();
                    return [4 /*yield*/, effects.newcoin.newcoin.getAccountBalance({ owner: user.username || "", contract: "pools.nco" })];
                case 2:
                    ps = _e.sent();
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2: return [2 /*return*/, _c[_d] = (_e.sent())];
            }
        });
    });
};
