...
var naiveQSDecode = function (search) {
    ...
    return search.slice(1).split(/&/).map(function (kv) { return kv.split(/=/); }).reduce(function (r, _a) {
        var _b;
        var k = _a[0], v = _a[1];
...
var routeAfterAuth = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            h0s = state.routing.simpleHistory.length ? state.routing.simpleHistory[0].search : undefined;
            qs0 = naiveQSDecode(h0s);
            if (qs0.path) {
                actions.routing.historyPush({ location: qs0.path });
                return [2 /*return*/];
            }
            nextRoute = !state.api.auth.authorized ? "/user-create" :
