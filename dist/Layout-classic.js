...
export const Layout = ({ children }) => {
    ...
    return (_jsxs(AntdLayout, { children: [_jsx(Header, { className: "header logo", children: _jsxs(Menu, { theme: "dark", mode: "horizontal", defaultSelectedKeys: ["2"], children: [_jsx(Menu.Item, { children: _jsx(Link, { to: "/explore" /*underlayColor="#f0f4f7"*/, className: "nav-item", children: _jsx("div", { className: `logo-image` }) }) }, "1"), _jsx(Menu.Item, { children: _jsx(Link, { to: "/payment/subscription" /*underlayColor="#f0f4f7"*/, className: "nav-item", children: _jsx("div", { children: "Subscribe" }) }) }, "0"), _jsx(Menu.Item, { children: _jsx(Link, { to: "/about" /*underlayColor="#f0f4f7"*/, className: "nav-item", children: "About" }) }, "2"), _jsx(Menu.Item, { children: _jsx(Link, { to: "/search-creative", className: "nav-item", children: "Creative Search" }) }, "3"), _jsx(Menu.Item, { children: _jsx(Link, { to: "/explore", className: "nav-item", children: "Explore" }) }, "4"), _jsx(Menu.Item, { children: _jsx(Link, { to: "/post-create", className: "nav-item", children: _jsx(PlusCircleOutlined, {}) }) }, "5"), _jsx(AuthWidget, {})] }) }, "h"), _jsx(AntdLayout, { children: _jsx(AntdLayout, { style: { padding: "0 0 24px" }, children: _jsx(Content, { className: "site-layout-background", style: {
                            padding: 24,
                            margin: "auto",
                            minHeight: 280,
                            maxWidth: "90vw",
                            minWidth: "80vw",
                        }, children: state.auth.status < AUTH_FLOW_STATUS.AUTHENTICATED ? (
