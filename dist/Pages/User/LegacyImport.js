...
var capFirst_1 = require("../../utils/capFirst");
var STATUS = {
    NONE: 0,
    LINK_NO_EMAIL: 1,
    LINK_EMAIL: 2,
...
var LegacyLogin = function () {
    ...
    var _d = (0, react_1.useState)(STATUS.NONE), status = _d[0], setStatus = _d[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    setError((0, capFirst_1.capFirst)(ex_1.code
                        .replace(/^auth\//, "")
                        .replace(/-/g, " ")));
    ...
    if (error)
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("h2", __assign({ className: "heading-2" }, { children: ["Error: ", error] })), (0, jsx_runtime_1.jsx)("div", { className: "section-divider" }), (0, jsx_runtime_1.jsxs)(antd_1.Row, { children: [(0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ xs: 24, xxl: 12 }, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, __assign({ onClick: tryAgain }, { children: "Try again" })) })), (0, jsx_runtime_1.jsx)(antd_1.Col, __assign({ xs: 24, xxl: 12 }, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, __assign({ onClick: function () {
                                ...
                                } }, { children: "Get onboarded using your phone" })) }))] })] }));
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [state.auth.authenticated ? ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: state.api.auth.authorized ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "section-divider" }), (0, jsx_runtime_1.jsxs)("h2", { children: ["Hi ", ((_a = state.api.auth.user) === null || _a === void 0 ? void 0 : _a.username) || ((_b = state.api.auth.user) === null || _b === void 0 ? void 0 : _b.displayName), ", we've been missing you!"] }), (0, jsx_runtime_1.jsx)("div", { className: "section-divider" }), (0, jsx_runtime_1.jsx)("p", { children: "Please take a few steps to access the brand new version of Newlife." }), (0, jsx_runtime_1.jsx)("div", { className: "section-divider" }), (0, jsx_runtime_1.jsx)(antd_1.Button, __assign({ onClick: function () {
                                return actions.flows.user.create.startLegacyImport();
                            } }, { children: "Continue" }))] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("h2", { children: "Email authorization is only available for existing users of Newlife V1." }), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsxs)("p", { children: ["We could not find your email in our database.", (0, jsx_runtime_1.jsxs)("ul", __assign({ className: "app-ul-simple" }, { children: [(0, jsx_runtime_1.jsxs)("li", { children: [email ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: ["You used the email ", email, (0, jsx_runtime_1.jsx)("br", {})] })) : (""), "Please make sure you are using the same email you were using to access Newlife V1. You may want to", (0, jsx_runtime_1.jsx)("div", { className: "section-divider" }), (0, jsx_runtime_1.jsx)(antd_1.Button, __assign({ onClick: tryAgain }, { children: "Try again" }))] }), (0, jsx_runtime_1.jsxs)("li", { children: ["Please make sure you have not migrated your account to v2 yet. If you had", (0, jsx_runtime_1.jsx)("div", { className: "section-divider" }), (0, jsx_runtime_1.jsx)(antd_1.Button, __assign({ onClick: function () {
                                                    ...
                                                    } }, { children: "Get onboard using your phone" }))] })] })), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("br", {})] })] })) })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {})), status == STATUS.LINK_REQUESTED ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: ["Please check your inbox at ", email] })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {})), status === STATUS.NONE && !((_c = state.api.auth.user) === null || _c === void 0 ? void 0 : _c.id) ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("p", __assign({ className: "super-size font-variant-none" }, { children: "join NewLife.IO" })), (0, jsx_runtime_1.jsx)("div", { className: "section-divider" }), (0, jsx_runtime_1.jsxs)(antd_1.Form, __assign({ form: form, name: "basic", initialValues: { email: "" }, onFinish: onFinish, 
                        // onFinishFailed={onFinishFailed}
                        autoComplete: "off" }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, __assign({ name: "email", rules: [
