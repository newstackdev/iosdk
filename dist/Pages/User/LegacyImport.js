...
var LegacyLogin = function () {
  ...
  var _d = (0, react_1.useState)(STATUS.NONE),
    status = _d[0],
    setStatus = _d[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              actions.firebase.signInWithEmailLink({ email: email }),
            ];
          case 1:
            _a.sent();
            return [3 /*break*/, 3];
          case 2:
            ...
            setError(
              (0, capFirst_1.capFirst)(
                ex_1.code.replace(/^auth\//, "").replace(/-/g, " ")
              )
            );
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
      children: [
        (0, jsx_runtime_1.jsxs)(
          "h2",
          __assign({ className: "heading-2" }, { children: ["Error: ", error] })
        ),
        (0, jsx_runtime_1.jsx)("div", { className: "section-divider" }),
        (0, jsx_runtime_1.jsxs)(antd_1.Row, {
          children: [
            (0, jsx_runtime_1.jsx)(
              antd_1.Col,
              __assign(
                { xs: 24, xxl: 12 },
                {
                  children: (0, jsx_runtime_1.jsx)(
                    antd_1.Button,
                    __assign({ onClick: tryAgain }, { children: "Try again" })
                  ),
                }
              )
            ),
    ...
    children: [
      state.auth.authenticated
        ? (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {
            children: state.api.auth.authorized
              ? (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
                  children: [
                    ...
                    (0, jsx_runtime_1.jsxs)("h2", {
                      children: [
                        ...
                        ((_a = state.api.auth.user) === null || _a === void 0
                          ? void 0
                          : _a.username) ||
                          ((_b = state.api.auth.user) === null || _b === void 0
                            ? void 0
                            : _b.displayName),
                    ...
                    (0, jsx_runtime_1.jsx)("p", {
                      children:
                        "Please take a few steps to access the brand new version of Newlife.",
                    }),
                    (0, jsx_runtime_1.jsx)("div", {
                      className: "section-divider",
                    }),
              ...
              : (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
                  children: [
                    (0, jsx_runtime_1.jsx)("h2", {
                      children:
                        "Email authorization is only available for existing users of Newlife V1.",
                    }),
                            ...
                            { className: "app-ul-simple" },
                            {
                              children: [
                                (0, jsx_runtime_1.jsxs)("li", {
                                  children: [
                                    email
                                      ...
                                      : "",
                                    "Please make sure you are using the same email you were using to access Newlife V1. You may want to",
                                    (0, jsx_runtime_1.jsx)("div", {
                                      className: "section-divider",
                                    }),
                                    (0, jsx_runtime_1.jsx)(
                                  ...
                                  children: [
                                    ...
                                    (0, jsx_runtime_1.jsx)(
                                      ...
                                      __assign(
                                        ...
                                        { children: "Sign in using your phone" }
                                      )
                                    ),
                                  ],
                                }),
                                (0, jsx_runtime_1.jsx)("li", {
                                  children:
                                    "If you still believe this is an error please contact Newlife at info@newlife.io and we will try to help.",
                                }),
                                (0, jsx_runtime_1.jsxs)("li", {
                                  children: [
                                    "Otherwise",
      ...
      status == STATUS.LINK_REQUESTED
        ? (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
            children: ["Please check your inbox at ", email],
          })
        : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}),
      status === STATUS.NONE &&
      !((_c = state.api.auth.user) === null || _c === void 0 ? void 0 : _c.id)
        ? (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
            children: [
              (0, jsx_runtime_1.jsx)(
                "p",
                ...
                __assign(
                  ...
                  },
                  {
                    children: [
                      ...
                      (0, jsx_runtime_1.jsx)(antd_1.Form.Item, {
                        children: (0, jsx_runtime_1.jsx)(
                          "div",
                          __assign(
                      ...
                      (0, jsx_runtime_1.jsx)(
                        "p",
                        __assign(
                          { className: "paragraph-2r text-center" },
                          {
                            children: (0, jsx_runtime_1.jsx)(
                              react_router_dom_1.Link,
                              __assign(
                                { to: "/" },
                                { children: "I don't have an account yet!" }
                              )
                            ),
                          }
                        )
                      ...
                      (0, jsx_runtime_1.jsx)(SupportBox_1.default, {}),
                    ],
                  }
                )
              ),
