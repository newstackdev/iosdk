  ...
  return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
    children: [
      ...
      (0, jsx_runtime_1.jsx)(
        "div",
        __assign(
          { className: "error-circle-form " },
          { children: (0, jsx_runtime_1.jsx)(CrossCircle_1.CrossCircle, {}) }
        )
      ),
    ],
  });
...
var UserCreate = function (_a) {
  var hideUsername = _a.hideUsername,
    noRouing = _a.noRouing,
    embedded = _a.embedded,
    setNext = _a.setNext,
    setIsErrorSubmit = _a.setIsErrorSubmit;
        ...
        __assign(
          {
            ...
            autoComplete: "off",
            onFieldsChange: function (_ch, all) {
              var upd = _ch.reduce(function (r, c) {
                var _a;
                // @ts-ignore
                return __assign(
                  __assign({}, r),
                  ((_a = {}), (_a[c.name[0]] = c.value || c.values), _a)
                );
              }, sf);
            ...
            children: [
                ...
                __assign(
                  ...
                  },
                  {
                    children: (0, jsx_runtime_1.jsx)(antd_1.Input, {
                      ...
                      suffix: (0, jsx_runtime_1.jsx)(
                        exports.CrossCircleErr,
                        {}
                      ),
                    }),
                  }
              ...
              (0, jsx_runtime_1.jsx)(
                ...
                __assign(
                  { name: "description" },
                  {
                    children: (0, jsx_runtime_1.jsx)(antd_1.Input.TextArea, {
                      placeholder: "bio",
                    }),
                  }
                )
                    ...
                    children: (0, jsx_runtime_1.jsx)(
                      RowCheckbox_1.RowCheckbox,
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          "p",
                          __assign(
                            { className: "paragraph-2r", style: { margin: 0 } },
                            { children: "I agree to Newlife's privacy policy" }
                          )
                        ),
                      }
                    ),
                    ...
                    children: (0, jsx_runtime_1.jsx)(
                      RowCheckbox_1.RowCheckbox,
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          ...
                          __assign(
                            { className: "paragraph-2r", style: { margin: 0 } },
                            { children: "I consent to email communications" }
                          )
                        ),
                      }
                    ),
                    ...
                    children: (0, jsx_runtime_1.jsx)(
                      RowCheckbox_1.RowCheckbox,
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          ...
                          __assign(
                            { className: "paragraph-2r", style: { margin: 0 } },
                            { children: "I'd like to join the beta group!" }
                          )
                        ),
                      }
                    ),
              ...
              (0, jsx_runtime_1.jsx)(
                form_1.default.Item,
                __assign(
                  { hidden: embedded, wrapperCol: { offset: 8, span: 16 } },
                  {
                    children: (0, jsx_runtime_1.jsx)(
