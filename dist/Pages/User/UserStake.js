...
var fixValue = function (v) {
  return v
    ...
    .replace(/^(\d+)\.(\d+)?(.*)$/, function (_, m1, m2) {
      return ""
        .concat(m1.slice(0, 6), ".")
        .concat(pad((m2 || "").slice(0, 4), 4, "left"));
    });
};
...
var UserStake = function (_a) {
  ...
  // if(state.auth)
  if (!user) return (0, jsx_runtime_1.jsx)(antd_1.Spin, {});
    ...
    __assign(
      {
        ...
        info: (0, jsx_runtime_1.jsx)(UserWidget_1.UserWidgetHeading, {
          user: user,
                ...
                children: [
                  ...
                  (0, jsx_runtime_1.jsxs)("p", {
                    children: [
                      ...
                      recentlyStaked
                        .map(function (m) {
                          return m.original.updated;
                        })
                        .join(", "),
                    ],
                  }),
                  (0, jsx_runtime_1.jsx)("p", {
                    children: "You are welcome to stake again.",
                  }),
                ],
              })
            : "",
                    ...
                    __assign(
                      {
                        name: "amount",
                        rules: [
                          { required: true, message: "Enter amount please" },
                        ],
                      },
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          antd_mask_input_1.MaskedInput,
                          {
