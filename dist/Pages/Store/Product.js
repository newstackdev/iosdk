...
const CheckoutForm = ({ embedded, setNext }) => {
    ...
    _jsxs(Form, { form: form, onFinish: () => actions.payments.pay({ stripe, elements }), children: [_jsxs("div", { className: "text-center", children: [_jsx(Input, { onChange: (e) => actions.flows.user.create.updateForm({ couponCode: e.target.value }), placeholder: "Enter a coupon code here" }), _jsx("br", {}), _jsx("br", {}), _jsx("br", {})] }), _jsx(Form.Item, { name: "payment", children: _jsx("div", { style: { minHeight: 142 }, children: _jsx(PaymentElement, { onChange: onPaymentElementChanged }) }) }), _jsx(Form.Item, { hidden: embedded, children: _jsxs("div", { className: "flex-space-between", children: [_jsx(ProgressButton, { progressText: "Cancelling payment...", type: "primary", actionName: "routing.goBack", onClick: () => actions.routing.goBack(), htmlType: "button", disabled: !stripe || !elements, children: "Cancel" }), _jsx(ProgressButton, { progressText: "Processing payment...", type: "primary", actionName: "payments.pay", htmlType: "submit", disabled: !stripe || !elements, children: "Submit" })] }) })] })
    // </Elements>
    );
};
