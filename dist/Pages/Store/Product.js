...
exports.Product =
  ...
  exports.handlePaymentThatRequiresCustomerAction =
    void 0;
...
var state_1 = require("../../state/auth/state");
...
var stripePromise = (0, stripe_js_1.loadStripe)(
  "pk_test_wPJ6hXufjI4FCyabWUFsEnRf002P6QN6lX"
);
function handlePaymentThatRequiresCustomerAction(stripe, _a) {
  ...
  var subscription = _a.subscription,
    invoice = _a.invoice,
    priceId = _a.priceId,
    paymentMethodId = _a.paymentMethodId,
    isRetry = _a.isRetry;
          ...
          if (
            ((_b =
              result === null || result === void 0
                ? void 0
                : result.paymentIntent) === null || _b === void 0
              ? void 0
              : _b.status) === "succeeded"
          ) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api.payment.stripeSubscriptionCreate({
      ...
      __assign(
        {
          form: form,
          onFinish: function () {
            return actions.payments.pay({ stripe: stripe, elements: elements });
          },
        },
        {
          children: [
                    ...
                    __assign(
                      { style: { minHeight: 142 } },
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          ...
                          { onChange: onPaymentElementChanged }
                        ),
                      }
                    )
                  ),
...
var Product = function (_a) {
  ...
  var embedded = _a.embedded,
    setNext = _a.setNext;
  var _d = (0, react_1.useState)({ options: { clientSecret: "" }, intent: {} }),
    flowState = _d[0],
    setFlowState = _d[1];
  var state = (0, overmind_1.useAppState)();
  var actions = (0, overmind_1.useActions)();
  var _e = (0, react_1.useState)("io-domain-presale-standard"),
    price = _e[0],
    setPrice = _e[1];
  console.log(price);
  (0, react_1.useEffect)(
  ...
  (0, react_1.useEffect)(
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  state.api.client.payment.stripeIntentCreate({
    ...
    [
      price,
      (_b = state.api.auth.user) === null || _b === void 0 ? void 0 : _b.id,
  ...
  if (!((_c = state.api.auth.user) === null || _c === void 0 ? void 0 : _c.id))
    return (0, jsx_runtime_1.jsx)(
      "div",
      __assign(
        { className: "app-main-centered", style: { minWidth: 150 } },
        {
          children: (0, jsx_runtime_1.jsx)(
            IndeterminateProgress_1.IndeterminateProgress,
            { inProgress: true }
          ),
        }
      )
  ...
  return (0, jsx_runtime_1.jsxs)(
    "div",
    __assign(
      { className: "app-main-full-height-only-with-bottom-control" },
      {
        children: [
          (0, jsx_runtime_1.jsx)(
            antd_2.Checkbox.Group,
            __assign(
              {
                value: price,
                onChange: function (v) {
                  return setPrice(v[v.length - 1]);
                },
                style: { width: "100%" },
              },
              {
                  ...
                  __assign(
                    { align: "bottom", justify: "space-between" },
                    {
                      children: [
                        ...
                        (0, jsx_runtime_1.jsx)(antd_1.Col, {
                          children: (0, jsx_runtime_1.jsx)(
                            "p",
                            __assign(
          ...
          paymentIntent["amount"] &&
            (0, jsx_runtime_1.jsxs)(
              ...
              __assign(
                { className: "header-2" },
                { children: ["Total: ", paymentIntent["amount"] / 100, "EUR"] }
              )
            ),
          (0, jsx_runtime_1.jsx)("br", {}),
          (0, jsx_runtime_1.jsx)(
            "div",
            __assign(
              { style: { maxWidth: 600, minHeight: 380 } },
              {
                children:
                  options.clientSecret &&
                  (0, jsx_runtime_1.jsx)(
                    react_stripe_js_2.Elements,
                    __assign(
                      { stripe: stripePromise, options: options },
                      {
                        children: (0, jsx_runtime_1.jsx)(CheckoutForm, {
                          embedded: embedded,
                          setNext: setNext,
                        }),
                      }
