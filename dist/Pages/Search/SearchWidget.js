...
var react_outside_click_handler_1 = __importDefault(
      ...
      },
      {
        children:
          ...
          ((_b = res === null || res === void 0 ? void 0 : res.value) ===
            ...
            ? void 0
            : _b.length)
            ? (0, jsx_runtime_1.jsx)(UserWidget_1.UsersList, {
                users: res.value,
                powerUp: false,
              })
            : res &&
              !((_c = res === null || res === void 0 ? void 0 : res.value) ===
                null || _c === void 0
                ? void 0
                : _c.length)
            ? "No results"
        ...
        children: [
          (0, jsx_runtime_1.jsx)(
            ...
            __assign(
              ...
              { children: (0, jsx_runtime_1.jsx)(Searchicon_1.Searchicon, {}) }
            )
          ),
          (0, jsx_runtime_1.jsx)(
            "div",
                  ...
                  __assign(
                    ...
                    },
                    {
                      children: (0, jsx_runtime_1.jsx)(
                        antd_1.Col,
                        __assign(
                          { span: 20, className: "app-main-full-width-only" },
                          {
                            children:
                              search &&
                              (0, jsx_runtime_1.jsx)(
                                ...
                                __assign(
                                  {
                                    ...
                                    placement: "topCenter",
                                    overlay: (0, jsx_runtime_1.jsx)(
                                      exports.SearchResultsWidget,
                                      { query: query }
                                    ),
                                    //@ts-ignore
                                  ...
                                  },
                                  {
                                    children: (0, jsx_runtime_1.jsxs)(
                                      ...
                                      __assign(
                                        {
                                          className:
                                            "app-main-full-width-only search-row",
                                        },
                                        {
                                          children: [
                                            (0, jsx_runtime_1.jsx)(
