...
var useVotingStreamMood = function () {
  var _a = (0, react_router_1.useParams)(),
    moodId = _a.moodId,
    postId = _a.postId,
    id = _a.id;
  ...
  var getIndex = function () {
    ...
    if (
      index &&
      ((_a = moodPosts[index]) === null || _a === void 0 ? void 0 : _a.id) ==
        currPost.id
    )
      return;
    console.log("mp:", currMood.id, currPost.id);
    var ix = moodPosts.findIndex(function (p) {
      return p.id === postId;
    });
    setIndex(ix > 0 ? ix : 0);
  };
  ...
  var getPosts = function (m) {
    var cm =
      state.api.cache.moods[(m === null || m === void 0 ? void 0 : m.id) || ""];
    return cm && cm.posts ? cm.posts : [];
  };
  var nextPath = function () {
    var _a, _b;
    var _nextPostId =
      (_a = moodPosts[index + 1]) === null || _a === void 0 ? void 0 : _a.id;
    var nextMood = _nextPostId
      ? currMood
      : ((_b = currPost.moods) === null || _b === void 0
          ? void 0
          : _b.find(function (md) {
              return currMood.id != md.id && getPosts(md).length;
            })) ||
        state.lists.top.moods.items.find(function (md) {
          return currMood.id !== md.id && getPosts(md).length;
        });
    ...
    var nextPath = "/folder/"
      .concat(
        nextMood === null || nextMood === void 0 ? void 0 : nextMood.id,
        "/"
      )
      .concat(nextPost); //(index != null) && moodPosts[index + 1]?.id ?
    return nextPath;
  };
  return {
    nextPath: nextPath,
...
var Post = function () {
  ...
  var state = (0, overmind_1.useAppState)();
  var actions = (0, overmind_1.useActions)();
  var moodsToAttach = (state.api.auth.moods || []).filter(function (m) {
    return m.id;
  }); // current users's moods
  var _h = useVotingStreamMood(),
    moodId = _h.moodId,
    currMood = _h.currMood,
    currPost = _h.currPost,
    nextPath = _h.nextPath,
    index = _h.index,
    isInMood = _h.isInMood;
  var author = (0, useCached_1.useCachedUser)({
    id: currPost
      ? (_a =
          currPost === null || currPost === void 0
            ? void 0
            : currPost.author) === null || _a === void 0
        ? void 0
        : _a.id
      : "",
  });
  var username =
    (author === null || author === void 0 ? void 0 : author.username) ||
    (author === null || author === void 0 ? void 0 : author.displayName);
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (
              !((_a =
                form === null || form === void 0 ? void 0 : form.moods) ===
                null || _a === void 0
                ? void 0
                : _a.length)
            )
            ...
            return [
              4 /*yield*/,
              actions.api.post.attachToMoods({
                post: currPost,
                moods:
                  (form === null || form === void 0 ? void 0 : form.moods) ||
                  [],
  ...
  return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
    children: [
        ...
        __assign(
          {
            ...
            info: (0, jsx_runtime_1.jsxs)(
              "div",
              __assign(
                { className: "post-info-column" },
                {
                  children: [
                    (0, jsx_runtime_1.jsx)(
                      "h2",
                    ...
                    (
                      (_b = currPost.author) === null || _b === void 0
                        ? void 0
                        : _b.newcoinPoolTx
                    )
                      ? (0, jsx_runtime_1.jsxs)(
                          antd_1.Row,
                          __assign(
                            { className: "paragraph-2u", align: "bottom" },
                            {
                              children: [
                                (0, jsx_runtime_1.jsx)(
                                  "a",
                                  __assign(
                                    ...
                                    { children: "Creator pool" }
                                  )
                                ),
                                (0, jsx_runtime_1.jsx)(Ebene_1.Ebene, {}),
                              ],
                            }
                          )
                        )
                    ...
                    (0, jsx_runtime_1.jsx)(
                      ...
                      __assign(
                        { className: "paragraph-2u", align: "bottom" },
                        {
                          children: !currPost.newcoinMintTx
                            ? ""
                            ...
                            : (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
                                children: [
                                  (0, jsx_runtime_1.jsx)(
                                    Profile_1.NewcoinLink,
                                    __assign(
                                      { tx: currPost.newcoinMintTx },
                                      { children: "See minted NFT" }
                                    )
                                  ),
                                  (0, jsx_runtime_1.jsx)(NTFIcon_1.NFTIcon, {}),
                                ],
                              }),
                        }
                      )
                    ...
                    (0, jsx_runtime_1.jsx)("div", {
                      children: (0, jsx_runtime_1.jsx)(Share_1.ShareButton, {}),
                    }),
                    (0, jsx_runtime_1.jsx)("br", {}),
                    (0, jsx_runtime_1.jsx)("br", {}),
                    (
                      (_d = currPost.tags) === null || _d === void 0
                        ? void 0
                        : _d.length
                    )
                      ? "Tags:"
                    ...
                    (_g =
                      (_f =
                        (_e = (0, overmind_2.json)(currPost.tags || [])) ===
                          null || _e === void 0
                          ? void 0
                          : _e.sort(function (a, b) {
                              return b["_rel"].score - a["_rel"].score;
                            })) === null || _f === void 0
                        ? void 0
                        : _f.slice(0, 10)) === null || _g === void 0
                      ? void 0
                      : _g.map(function (t) {
                          return (0,
                          jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "text-small" }, { children: t.value })), (0, jsx_runtime_1.jsx)(antd_1.Progress, { strokeColor: "#c1fa50", percent: t["_rel"].score * 100 })] });
                        }),
                  ],
                }
              )
          ...
          {
            children: /PROCESSING/i.test(currPost.contentUrl || "")
              ? (0, jsx_runtime_1.jsx)(Spin_1.Spin, {
                  title: "Processing media...",
                })
              : (0, jsx_runtime_1.jsx)(
                  Image_1.ContentImage,
                  __assign({}, currPost, { thumbnail: false })
                ),
          }
        )
      ),
      (0, jsx_runtime_1.jsx)(
        "div",
        __assign(
          { className: "text-right app-main-full-width" },
          { children: (0, jsx_runtime_1.jsx)(PostModal_1.default, {}) }
        )
      ),
      (0, jsx_runtime_1.jsx)(
        "div",
        __assign(
          ...
          {
            children: (0, jsx_runtime_1.jsx)(SelectMood_1.SelectMoodForm, {
              onFinish: addToMoods,
