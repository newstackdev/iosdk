...
var PostCreate = function (props) {
  ...
  var _b = (0, react_1.useState)(false),
    mintConfirmationOpen = _b[0],
    setMintConfirmationOpen = _b[1];
  var _c = (0, react_1.useState)({
      name: constants_1.LICENSES[0][0],
      value: constants_1.LICENSES[0][1],
    }),
    selectedLicense = _c[0],
    setSelectedLicense = _c[1];
  ...
  var _h = (0, react_1.useState)(false),
    mintNFTswitch = _h[0],
    setMintNFTswitch = _h[1];
  var user = state.api.auth.user;
  // balance check
  var balances =
    ((_a = state.newcoin.account) === null || _a === void 0
      ? void 0
      : _a.acc_balances) || [];
          ...
          case 1:
            ...
            if (!contentType) {
              ...
              if (!f.type) {
                return [
                  2 /*return*/,
                  effects.ux.message.warning(
                    "Unrecognized/unsupported content type. Upload something else."
                  ),
                ];
              }
            }
            postForm = __assign(__assign({}, values), {
            ...
            return [
              4 /*yield*/,
              actions.api.post.create({ postForm: postForm }),
            ];
          case 2:
            p = _a.sent();
            ...
            __assign(
              ...
              },
              {
                children: (0, jsx_runtime_1.jsx)(
                  ContentLayout_1.ContentLayout,
                  __assign(
                    {
                      isPost: true,
                      header: (0, jsx_runtime_1.jsx)(
                        PostCreateHeader_1.default,
                        {
                      ...
                      info: (0, jsx_runtime_1.jsx)(PostCreateInfo_1.default, {
                        selectedLicense: selectedLicense,
                    ...
                    },
                    {
                      children: (0, jsx_runtime_1.jsxs)(
                        "div",
                        __assign(
                          { className: "post-create-form-width" },
                          {
                            children: [
                              (0, jsx_runtime_1.jsx)(
                                form_1.default.Item,
                                  ...
                                  { name: "doMint" },
                                  {
                                    children: [
                                      ...
                                      (0, jsx_runtime_1.jsx)(
                                        ...
                                        {
                                          onChange: function () {
                                            return setMintNFTswitch(function (
                                              p
                                            ) {
                                              return !p;
                                            });
                                          ...
                                          checkedIcon: (0, jsx_runtime_1.jsx)(
                                            jsx_runtime_1.Fragment,
                                            {}
                                          ),
                                          uncheckedIcon: (0, jsx_runtime_1.jsx)(
                                            jsx_runtime_1.Fragment,
                                            {}
                                          ),
                                          onColor:
                                                ...
                                                __assign(
                                                  {
                                                    placement: "right",
                                                    title:
                                                      "Share your content with No Rights Reserved with Creative Commons.",
                                                  },
                                                  {
                                                    children: (0,
                                                    jsx_runtime_1.jsx)("span", {
                              ...
                              (0, jsx_runtime_1.jsx)(form_1.default.Item, {
                                label: "",
            ...
            __assign(
              {
                ...
                onOk: function () {
                  return setMintConfirmationOpen(false);
                },
                onCancel: function () {
                  return setMintConfirmationOpen(false);
                },
                ...
                closeIcon: (0, jsx_runtime_1.jsx)(
                  CrossCircle_1.CrossCircle,
                  {}
                ),
              },
              {
                    ...
                    __assign(
                      { style: { width: "100%" } },
                      {
                        children: [
                          ...
                          (0, jsx_runtime_1.jsxs)(antd_1.Col, {
                            children: [
                              (0, jsx_runtime_1.jsx)(
                                "p",
                                __assign(
                ...
                children: [
                  (0, jsx_runtime_1.jsx)(
                    ...
                    __assign(
                      ...
                      { children: "Share to your folders" }
                    )
                  ),
                  (0, jsx_runtime_1.jsx)(
                    form_1.default.Item,
                    __assign(
                      { name: "moods", style: { marginBottom: "40px" } },
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          SelectMood_1.SelectMood,
                          { moods: moods }
                        ),
                      }
                    )
