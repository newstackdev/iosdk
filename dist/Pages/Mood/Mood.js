...
const Mood = () => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "section-divider", children: (0, jsx_runtime_1.jsxs)(ContentLayout_1.ContentLayout, { isWorking: !mood?.posts?.length, header: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(antd_1.Row, { style: {
                            ...
                            marginBottom: "40px",
                                    ...
                                    alignItems: "center",
                                    display: "flex",
                                }, children: (0, jsx_runtime_1.jsx)(ThreeDots_1.ThreeDots, {}) })] }), (0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: "40px" }, className: "sparse-vertical-children", children: [(0, jsx_runtime_1.jsx)("p", { className: "paragraph-2b", children: moodDetails.title }), (0, jsx_runtime_1.jsx)("p", { className: "paragraph-2r", children: moodDetails.description || "" }), stakeInfo.toAccess ?
                                (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("p", { className: "paragraph-2r", children: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { children: ["Stake to access: ", stakeInfo.toAccess || "", " "] }), (0, jsx_runtime_1.jsxs)("div", { children: ["Your stake: ", stakeInfo.currentUserStake] })] }) }) })
                                : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {})] })] }), children: [(0, jsx_runtime_1.jsx)("div", { className: "nl-white-box sparse-vertical-children", children: !stakeInfo.currentUserEligible ?
                        (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { children: "Stake to access this folder" }), (0, jsx_runtime_1.jsx)(UserWidget_1.UserStake, { onDone: () => { }, user: user })] })
                        :
                            (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: "You are eligible to access this folder" }) }), (0, jsx_runtime_1.jsx)(TopFolders_1.TopFoldersGrid, { mood: mood, noFolder: true, postNumber: 3, title: "Moods", blur: !stakeInfo.currentUserEligible })] }) }));
};
exports.Mood = Mood;
const MoodDetailed = () => {
    const { moodId: id } = (0, react_router_1.useParams)();
