...
var Auth = function (_a) {
    ...
    // 			</p>
    // 		);
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "app-main-centered" }, { children: [(0, jsx_runtime_1.jsx)("div", { id: "sign-in-button" }), (0, jsx_runtime_1.jsxs)(form_1.default, __assign({ form: phoneForm, hidden: state.auth.status != state_1.AUTH_FLOW_STATUS.ANONYMOUS }, layout, { name: "basic", initialValues: { phone: "+420111111111" }, onFinish: function (_a) {
                    var phone = _a.phone;
