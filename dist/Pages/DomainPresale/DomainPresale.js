...
var DomainSelector = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_mask_input_1.MaskedInput, { ref: el, style: {
                ...
                (0, jsx_runtime_1.jsx)("div", __assign({ style: { position: "absolute" } }, { children: (0, jsx_runtime_1.jsx)(Spin_1.Spin, {}) })), fuia === "unavailable" && ((0, jsx_runtime_1.jsxs)(antd_1.Tag, __assign({ style: { marginTop: "20px" } }, { children: ["Name is ", fuia] }))), (0, jsx_runtime_1.jsxs)(Paragraph_1.default, __assign({ className: "paragraph-2r nl-footer-paragraph", style: { marginTop: 48, width: "60%" } }, { children: [isPaidUsername ?
                        (0, jsx_runtime_1.jsxs)(Appearing_1.AppearingComponent, __assign({ seconds: 1 }, { children: [(0, jsx_runtime_1.jsx)("br", {}), "Premium usernames shorter than 5 characters will soon be available.", (0, jsx_runtime_1.jsx)("br", {}), "For early access please contact\u00A0", (0, jsx_runtime_1.jsx)("a", __assign({ href: "https://t.me/joinchat/Ezz_sQzaOK2j977siawwGQ", target: "_new" }, { children: "our support team" })), "."] }))
                        : "", (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("br", {}), state.flows.user.create.legacyToken &&
                        ((state.flows.user.create.form.displayName !== state.flows.user.create.form.username) || fuia === "unavailable")
                        ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Tooltip, __assign({ title: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: "Your Newlife identity is now a part of the Newcoin ecosystem and provides access to many exciting services. You may keep your current username as the display name on Newlife on the next dialog." }) }, { children: (0, jsx_runtime_1.jsx)("span", { children: "Why is my username changing?" }) })), "\u00A0", (0, jsx_runtime_1.jsxs)("a", __assign({ href: "/", onClick: function () {
                                        return actions.flows.user.create.stopLegacyImport();
                                    } }, { children: ["I am not", " ", state.flows.user.create.form.displayName ||
...
var DomainPresale = function () {
    ...
    if (isMember || (state.indicators.isWorking &&
