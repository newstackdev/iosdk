...
var DomainSelector = function () {
  ...
  return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
    children: [
      (0, jsx_runtime_1.jsx)(antd_mask_input_1.MaskedInput, {
        ref: el,
        style: {
        ...
        defaultValue:
          ((_a = state.flows.user.create.form.username) === null ||
          _a === void 0
            ? void 0
            : _a.replace(/\.io$/, "")) || "",
        size: "large",
      ...
      fuia === "checking" &&
        (0, jsx_runtime_1.jsx)(
          ...
          __assign(
            ...
            { children: (0, jsx_runtime_1.jsx)(Spin_1.Spin, {}) }
          )
        ),
      fuia === "unavailable" &&
        ...
        __assign(
          ...
          },
          {
            children: [
              isPaidUsername
                ? (0, jsx_runtime_1.jsxs)(
                    Appearing_1.AppearingComponent,
                    __assign(
                      { seconds: 1 },
                      {
                        children: [
                        ...
                        __assign(
                          {
                            title: (0, jsx_runtime_1.jsx)(
                              ...
                              {
                                children:
                                  "Your Newlife identity is now a part of the Newcoin ecosystem and provides access to many exciting services. You may keep your current username as the display name on Newlife on the next dialog.",
                              }
                            ),
                          },
                          {
                            children: (0, jsx_runtime_1.jsx)("span", {
                              children: "Why is my username changing?",
                            }),
                          }
                        )
                      ),
              ...
              !state.flows.user.create.legacyToken && !state.auth.authenticated
                ? (0, jsx_runtime_1.jsx)(
                    ...
                    __assign(
                      { to: "/auth/legacy", className: "paragraph-3b" },
                      {
                        children: (0, jsx_runtime_1.jsx)("b", {
                          children: "I'm an early Newlife user!",
                        }),
                      }
                    )
                  )
...
var InitSteps = function (setNext, setIsErrorSubmit) {
  return {
    SELECT_DOMAIN: SELECT_DOMAIN,
    AUTHENTICATE: {
      title: "",
      content: (0, jsx_runtime_1.jsx)(Auth_1.Auth, {
        embedded: true,
        setNext: setNext,
    ...
    SUBSCRIBE: {
      title: "",
      action: "payments.pay",
      content: (0, jsx_runtime_1.jsx)(Product_1.Product, {
        embedded: true,
        setNext: setNext,
      }),
    },
    CREATE_USER: {
      ...
      content: (0, jsx_runtime_1.jsx)(UserCreate_1.UserCreate, {
        embedded: true,
        setNext: setNext,
        hideUsername: true,
        noRouing: true,
...
var DomainPresale = function () {
  ...
  return (0, jsx_runtime_1.jsxs)(
    ...
    __assign(
      { customClass: "app-content-layout-domain-presale" },
      {
        children: [
                ...
                children: [
                  (0, jsx_runtime_1.jsx)(
                    ...
                    __assign(
                      ...
                      {
                        children:
                          "This will be your permanent domain and it cannot be changed or deleted.",
                      }
                    )
                  ),
                  (0, jsx_runtime_1.jsx)(
                    ...
                    __assign(
                      ...
                      { children: "9 characters max: a-z and 1-5" }
                    )
                  ),
                ],
              }
