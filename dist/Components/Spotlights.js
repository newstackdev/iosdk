...
const SpotlightGrid = ({ maxItems, title, mood }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: { width: "100%", height: "100%", display: "flex" }, children: postsList?.map((p, i) => ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            }, className: "bg-hover", children: [(0, jsx_runtime_1.jsx)(antd_1.Col, { className: "spotlight", children: (0, jsx_runtime_1.jsx)(PostWidget_1.MaybeLink, { to: !p.id
                            ? ""
                            : !mood
                                ? `/post/${p.id}`
                                : `/folder/${mood.id}/${p.id}`, className: p.contentType === "text/plain"
                            ? "maybelink"
                            : "", children: (0, jsx_runtime_1.jsx)(PostWidget_1.PostWidget, { mood: moodsList[i], post: p, username: p.author?.username, aspectRatio: p.aspectRatio, isSpotlight: true }) }) }), (0, jsx_runtime_1.jsx)("p", { className: title === undefined
