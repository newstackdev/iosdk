...
var contentVideoUrl = function (_a) {
    ...
    return contentUrl ?
        "".concat(config_1.newlifeMediaBucket, "/videos/").concat(id, "/").concat(videoContentPath, "/").concat(sizer, "/").concat(contentUrl)
        :
            "";
};
...
var VideoComponent = function (props) {
    ...
    if (thumbnail) {
        var thumbnailUrl = "".concat(config_1.newlifeMediaBucket, "/videos/").concat(id, "/thumbnail/").concat(coverContentUrl === null || coverContentUrl === void 0 ? void 0 : coverContentUrl.replace(/[^.]+$/, function (m) { return "0000000.".concat(m); }));
