...
export const contentImageUrl = ({ id, contentUrl, size, }) => {
    const _sizer = imageSizes[size || ""];
    const sizer = _sizer ? [_sizer, _sizer].join("x") + "/" : "";
    return contentUrl
        ? `${newlifeMediaBucket}/images/${id}/${sizer}${contentUrl}`
        : previewImg;
};
export const ImageComponent = (props) => {
    ...
    const _sizer = imageSizes[size || ""];
    const imgUrl = overrideContentUrl || contentImageUrl(props);
