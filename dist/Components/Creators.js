...
export const CreatorWidget = ({ creator, avatarClassName, buttonType, setAddedUsers, addedUsers }) => {
    ...
    return (_jsx(Link, { to: `/user/${user.username}`, style: { width: "50%" }, children: _jsxs(Row, { className: "bg-hover app-full-width", style: { alignItems: "center", justifyContent: "space-between" }, children: [_jsxs(Col, { className: "top-creators-first-col u-margin-left-medium", xs: 13, children: [_jsx(Col, { children: _jsx(Avatar, { src: _jsx(ContentImage, { ...user }), className: avatarClassName }) }), _jsx(Row, { align: "bottom", style: { overflow: "hidden" }, children: _jsxs(Col, { className: "top-creators-username", style: { overflow: "hidden" }, children: [_jsxs("p", { className: "top-creators-username__paragraph", style: {
                                            ...
                                            overflow: "hidden",
                                            textOverflow: "ellips",
                                        }, children: ["powering ", creator.powering, " $", symbol] }))] }) })] }), _jsxs(Col, { className: "top-creators-second-col", xl: 10, children: [_jsx(Col, { className: "top-creators-number", children: _jsx("p", { className: "header-1r top-creators-powered", style: {
                                    margin: "0",
                                    justifyContent: "end",
                                    display: "flex",
                                    minWidth: "64px",
                                }, children: creator.powered }) }), _jsx(Col, {}), _jsx(Col, { style: { display: "flex", justifyContent: "flex-end", zIndex: 9999 }, children: buttonType === "addUser" ? (_jsx(Button, { onClick: () => {
