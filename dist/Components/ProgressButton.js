...
export const ProgressButton = ({ actionName, id, type, htmlType, className, children, onClick, disabled, isErrorSubmit, progressText }) => {
    const state = useAppState();
    const ival = !!state.indicators.specific[actionName];
    return (_jsx(_Fragment, { children: _jsx(Button, { id: id, type: type, htmlType: htmlType, onClick: onClick, disabled: disabled, 
