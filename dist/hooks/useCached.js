...
var useCachedUser = function (user, force) {
    ...
    var actions = (0, overmind_2.useActions)();
    var byIdOrUsername = function (u) {
        return ((u === null || u === void 0 ? void 0 : u.id) ?
            state.api.cache.users.byId[u === null || u === void 0 ? void 0 : u.id] :
            (u === null || u === void 0 ? void 0 : u.username) ? state.api.cache.users.byUsername[u === null || u === void 0 ? void 0 : u.username] :
                null);
    };
...
var useCachedMoods = function (moods, force) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        moods && moods.length &&
            state.auth.authenticated &&
            Promise.all(moods.map(function (_a) {
                var _b;
                var id = _a.id;
                return id && (force || !state.api.cache.moods[id] || !((_b = state.api.cache.moods[id].posts) === null || _b === void 0 ? void 0 : _b.length)) &&
                    actions.api.mood.read({ id: id });
